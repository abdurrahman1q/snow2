                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4">
                                <nav class="myaccount-tab-menu nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="myaccount-nav-link" href="?p=logout">Logout</a>
                                </nav>
                            </div>
                                    ...
                                    <div class="tab-pane fade show active" id="dashboad" role="tabpanel" aria-labelledby="dashboad-tab">
                                        <div class="myaccount-content">
                                            ...
                                            <div class="welcome">
                                                ...
                                                <p>Hello, <strong><?php echo $row['username']; ?> </strong> 
                                                (If Not <strong>Tuntuni !</strong><a href="login-register.html" class="logout"> Logout</a>)</p>
                                                <?php
                                            }}?> 
